...
SELECT ChaveAcessoNFe, * from NotasFiscaisConhecimento where SequencialConhecimento = 760000014504 
--UPDATE NotasFiscaisConhecimento SET ChaveAcessoNFe = Null WHERE SequencialConhecimento = 760000014504 
