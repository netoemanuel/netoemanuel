--
SELECT CodOrdemEmbarque, * from ConhecimentosTransporte where NumConhecto = 677013      and CodUF = 'GO'

--
SELECT CodOrdemEmbarque FROM ConhecimentosTransporte WHERE CodUF = 'SP' AND NumConhecto = 179355
--
SELECT EmpresaValePedagio, ValorPedagioSemParar, TipoDispositivoValePedagio FROM OrdemEmbarque WHERE NumOrdemEmbarque = 89002414
SELECT RotaSemParar, ValorPedagioSemParar, TipoDispositivoValePedagio FROM OrdemEmbarque WHERE NumOrdemEmbarque = 22076560

--
--Alterar dispositivo
--update OrdemEmbarque set TipoDispositivoValePedagio = 1 where NumOrdemEmbarque = 22076560
--update OrdemEmbarque set TipoDispositivoValePedagio = 0 where NumOrdemEmbarque = 22076560
--
--update OrdemEmbarque set NumCartaoValePedagio = null where NumOrdemEmbarque = 22076560
--Limpar a Roteirzação
--update OrdemEmbarque set EmpresaValePedagio = null , NumCartaoValePedagio = null  where  NumOrdemEmbarque = 22076560 
--
SELECT * FROM LogRoteirizacaoPedagio WHERE NumOrdemEmbarque = 89002414
--
...
--
select EmpresaValePedagio, NumCartaoValePedagio, TipoDispositivoValePedagio, *  FROM OrdemEmbarque WHERE NumOrdemEmbarque = 89002414 
--
...
WHERE CTRC.SerieConhecto = '0' AND CTRC.CodUF = 'MT' AND CTRC.Numconhecto = 677013
...
LEFT OUTER JOIN CartaFrete_Ocorrencia O ON O.IdCartaFrete = CF.Id
WHERE CTRC.SerieConhecto = '2' AND CTRC.CodUF = 'GO' AND CTRC.Numconhecto = 60610                 
...
from OrdemEmbarque_Log where NumOrdemEmbarque = 89002414 ORDER BY datalog desc
--
SELECT * FROM CartaFrete_Ocorrencia WHERE CodViagemPamcard = 80195288 -- 73906459
--
...
--update OrdemEmbarque set EmpresaValePedagio = null , NumCartaoValePedagio = null  where  NumOrdemEmbarque = 44061232 
