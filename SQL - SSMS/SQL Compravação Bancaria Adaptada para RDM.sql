...
--select codclientematriz from clientes_complemento where codcliente = 1000456
...
Declare @codclientematriz decimal set @codclientematriz = 1000456
Declare @DataInicio as varchar(25) set @DataInicio = '2024-09-17 00:00:00'
Declare @DataFim as varchar(25) set @DataFim = '2024-09-25 23:59:29'
...
where 
	...
	and ctrc.ValorTotalFrete between 4000 and 30000000
...
--BETWEEN '09/17/2024 00:00:00' AND '09/25/2024 23:59:29' 
--AND (ConhecimentosTransporte.SituacaoConhecto <> 'Cancelado' AND ConhecimentosTransporte.SituacaoConhecto <> 'Substituído') 
--AND ConhecimentosTransporte.ValorTotalFrete >= 4000.00 AND ConhecimentosTransporte.ValorTotalFrete <= 30000000.00 
--AND Clientes_Complemento.CodClienteMatriz = 1000456
--AND PedidosFrete.IndExportacao = 'S' 
--AND ConhecimentosTransporte.TipoConhecimento = 'Normal' 
