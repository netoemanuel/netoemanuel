...
--select codclientematriz from clientes_complemento where codcliente = 1000454
...
Declare @DataInicio as varchar(25) set @DataInicio = '2022-11-29 00:00:00'
Declare @DataFim as varchar(25) set @DataFim = '2022-12-02 23:59:29'
...
select CONVERT(varchar(8),ctrc.DataEmissao,3) AS 'Data Emissão', 
	...
	ctrc.CodUF AS UF, ctrc.NumConhecto AS 'Nº CT-e', convert(VARCHAR(44),cte.ID) AS 'Chave CT-e', 
	nf.NumeroNF AS 'Nº NF-e', convert(VARCHAR(44),nf.ChaveAcessoNFe) AS 'Chave NF-e', 
