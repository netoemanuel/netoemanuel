...
WHERE CTRC.SerieConhecto = '0' AND CTRC.CodUF = 'MG' AND CTRC.Numconhecto = 385413  
ORDER BY O.DataCriacao DESC, O.NumSeq DESC, O.SeqConsulta DESC

exec EmiteContrato 980000027116 ----carga_peso
...
select QuantidadeSaida, * from ConhecimentosTransporte where sequencial = 980000027116
--update ConhecimentosTransporte set QuantidadeSaida = 10970.250 where sequencial = 980000027116
