...
SELECT  * from PermissoesAcesso where CodUsuario in (15455) AND CodPrograma IN ('App_ConferenciaDocCte','App_Dashboard','App_ConsultarCTe') order by DataLog desc--AND CodPrograma IN ('App_ConferenciaDocCte','App_Dashboard'
